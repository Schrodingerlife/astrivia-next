...
import type { Relatorio } from './ReportCard';
import {
    Mic,
    MicOff,
    PhoneOff,
...
interface VoiceInterfaceProps {
    ...
    cenario: string;
    cenarioNome: string;
    onEncerrar: (relatorio: Relatorio) => void;
}
        ...
        <div className="flex flex-col h-full gap-4">
            ...
            <div className="flex gap-4 flex-1 min-h-0">
                    ...
                    <div className="border-t border-white/10 pt-4">
                        {modoTexto ? (
                            ...
                            <div className="flex flex-col items-center gap-3">
                                ...
                                <AudioVisualizer isGravando={isGravando} isFalando={isFalando} />
                ...
                <div className="w-80 glass-card rounded-xl p-4 flex flex-col hidden md:flex">
                    {/* Doctor Avatar */}
                    <DoctorAvatar isFalando={isFalando} paciencia={paciencia} medicoNome={medicoAtual.nome} />
